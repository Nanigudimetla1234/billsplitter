    ...
    <table class="table">
        ...
        <tbody>
            ...
            while ($rows = mysqli_fetch_assoc($exeteam)) {
                ...
                echo $rows['membernumber']."pina<br>";
                $size++;
                $flag = 0;
                while ($row = mysqli_fetch_assoc($distinctexecuted)) {
                    $members++;
                    $count++;
                    echo $row['paidnumber'] ."kinda<br>";
                    // if ($rows['membernumber'] == $row['paidnumber']) {
                    //     $flag = 1;
                    // }
                }
                // if ($flag == 0) {
                //     echo "alert.................................";
                //     echo $rows['membernumber']."not paind anything";
                // }
            }

            echo "sizesssssssssssssssssssssssssssssssssssssss" . $size;
